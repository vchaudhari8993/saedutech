...
namespace saEdu
{
    public partial class show_transaction_accountwise : Form
    {
        public show_transaction_accountwise()
        {
            InitializeComponent();
        }

        private void show_transaction_accountwise_Load(object sender, EventArgs e)
        {
            int counter1 = 0;
            int counter2 = 0;
            string s2;
            ...
            var httpWebRequest1 = (HttpWebRequest)WebRequest.Create(GlobalClass.url + "/show_transactions_of_single_account/");
            httpWebRequest1.ContentType = "application/json";
            httpWebRequest1.Method = "POST";
            httpWebRequest1.CookieContainer = new CookieContainer();
            httpWebRequest1.CookieContainer.Add(new Uri(GlobalClass.url + "/show_transactions_of_single_account/"), new Cookie("sessionid", GlobalClass.session));
